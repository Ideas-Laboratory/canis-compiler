...
function () {
  ...
  _createClass(LayerFactory, null, [{
    ...
    value: function getBoundingBox(dom) {
      ...
      var coordinate = [refBBox.left - rootBBox.left, refBBox.top - rootBBox.top, refWHBox.width + 1, refWHBox.height + 1];
      return coordinate;
    }
  }, {
    key: "boundingBox",
