        ...
        for (var i = 0; i < value.actionAttrs.length; i++) {
          ...
          if (tmpActionSpec.duration > 0) {
            ...
            if (tmpActionSpec.type === _ActionSpec.default.actionTargets.mark) {
              ...
              _GlobalVar.globalVar.markLayers.get(markId).setAnimatableProperty(tmpActionSpec.attribute.attrName, startFrame, endFrame, tmpActionSpec.attribute.from * 100, tmpActionSpec.attribute.to * 100, tmpActionSpec.easing);
              ...
              maskLayer.setAnimatableProperty(tmpActionSpec.attribute.attrName, _startFrame, _endFrame, tmpActionSpec.attribute.from * 100, tmpActionSpec.attribute.to * 100, tmpActionSpec.easing);
